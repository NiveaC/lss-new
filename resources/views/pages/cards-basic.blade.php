...
<div id="image-card" class="section">
  ...
  <div class="row">
    <div class="col s12 m6 l6">
      <div class="card">
        <div class="card-image">
          <img src="{{asset('images/gallery/4.png')}}" alt="sample" /> <span class="card-title">Card
            Title</span>
        </div>
        <div class="card-content">
          <p>
    ...
    <div class="col s12 m6 l6">
      <div class="card">
        <div class="card-image">
          <img src="{{asset('images/gallery/3.png')}}" alt="sample" /> <span class="card-title">Card
            Title</span>
        </div>
        <div class="card-content">
          <p>
...
<div id="fabs-card" class="section">
  ...
  <div class="row">
    <div class="col s12 m6 l6">
      <div class="card">
        <div class="card-image">
          <img src="{{asset('images/gallery/6.png')}}" alt="" /> <span class="card-title">Card
            Title</span>
    ...
    <div class="col s12 m6 l6">
      <div class="card">
        <div class="card-image">
          <img src="{{asset('images/gallery/8.png')}}" alt="" /> <span class="card-title">Card
            Title</span>
          <a
  ...
  <div class="row">
    <div class="col s12 m6 l6">
      <div class="card horizontal">
        <div class="card-image"><img src="{{asset('images/gallery/11.png')}}" alt="" /></div>
    ...
    <div class="col s12 m6 l6">
      <div class="card horizontal">
        <div class="card-image"><img src="{{asset('images/gallery/18.png')}}" alt="" /></div>
        <div class="card-stacked">
          <div class="card-content">
...
<div id="card-reveal" class="section">
  ...
  <div class="row">
    <div class="col s12 m6 l4">
      <div class="card">
        <div class="card-image waves-effect waves-block waves-light">
          <img class="activator" src="{{asset('images/gallery/12.png')}}" alt="office" />
        </div>
        <div class="card-content">
    ...
    <div class="col s12 m6 l4">
      <div class="card">
        <div class="card-image waves-effect waves-block waves-light">
          <img class="activator" src="{{asset('images/gallery/19.png')}}" alt="" />
        </div>
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4">Card Title <i
              class="material-icons right">more_vert</i>
    ...
    <div class="col s12 m6 l4">
      <div class="card sticky-action">
        <div class="card-image waves-effect waves-block waves-light">
          <img class="activator" src="{{asset('images/gallery/21.png')}}" alt="" />
        </div>
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4">Card Title <i
              class="material-icons right">more_vert</i>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 l6">
      <div class="card small">
        <div class="card-image">
          <img src="{{asset('images/gallery/23.png')}}" alt="sample" />
          <span class="card-title">Card Title</span>
        </div>
        <div class="card-content">
          <p>
  ...
  <div class="row">
    ...
    <div class="col s12 m7 l7">
      <div class="card medium">
        <div class="card-image">
          <img src="{{asset('images/gallery/25.png')}}" alt="sample" />
          <span class="card-title">Card Title</span>
        </div>
        <div class="card-content">
          <p>
  ...
  <div class="row">
    ...
    <div class="col s12 m8 l8">
      <div class="card large">
        <div class="card-image">
          <img src="{{asset('images/gallery/28.png')}}" alt="sample" />
          <span class="card-title">Card Title</span>
        </div>
        <div class="card-content">
          <p>
