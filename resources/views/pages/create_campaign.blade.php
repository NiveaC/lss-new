                  ...
                  <div class="col s12">
                    <div id="html-validations" class="card card-tabs">
                      <div class="card-content">
                        ...
                        <div class="row">
                          <div class="col s12">
                            <a class="add_btn btn waves-effect waves-light right"><i class="material-icons left" style="margin-right:5px;">arrow_forward_ios</i><span>Next</span></a>
                          </div>
                        </div>
                      </div>
                    </div>
                                  ...
                                  <p>
                                    <label>
                                      ...
                                      <span>Delivery Charge Option</span>
                                        ...
                                        <div class="input-field col s12 m4 p-0">
                  ...
                  <div class="col s12">
                    <div id="html-validations" class="card card-tabs">
                      ...
                      <div class="card-content">
                        ...
                        <div class="row">
                          <div class="col s12">
                            <a class="add_btn btn waves-effect waves-light right"><span>Save</span></a>
                          </div>
                        </div>
                      </div>
                    </div>
