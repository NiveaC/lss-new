    ...
    <h1 class="logo-wrapper">
      <a class="brand-logo darken-1" href="{{asset('/')}}">
        @if(!empty($configData['mainLayoutType']) && isset($configData['mainLayoutType']))
          ...
          <img class="show-on-medium-and-down hide-on-med-and-up" src="{{asset('images/lss-logo/logo_wh.png')}}"
      ...
      <a class="navbar-toggler white" href="javascript:void(0)"><i class="material-icons white">menu</i></a></h1>
  </div>
  <!-- 下面頁面選單 -->
  <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow sidebar_content" id="slide-out"
    ...
    <li class="navigation-header">
      <div class="row">
        ...
        <div class="col s10">
          <a href="#" class="navigation-header-text sidebar_text" style="font-size:14px;">Auto Reply</a>
        </div>
      </div>
    </li>
    <li class="navigation-header">
    ...
    <!-- 平台icon -->
    <div class="row platform_section" style="position:absolute; bottom: 0px; margin-bottom: 5rem;">
      <div class="col s12">
        <li class="navigation-header">
          <div class="row">
            <div class="col s2 left p-0">
